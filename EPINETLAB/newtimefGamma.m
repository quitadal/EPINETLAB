...
% 11-09-17 modified version for EPINETLAB software, by Lucia R. Quitadamo

function [P,R,mbase,timesout,freqs,Pboot,Rboot,alltfX,PA, maskersp, maskitc] = newtimefGamma( data, frames, tlimits, Fs, varwin, varargin);
